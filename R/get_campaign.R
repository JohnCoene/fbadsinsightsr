#' get_campaign
#' 
#' @description Get insights on advertising performances of an ad campaign. See \href{https://developers.facebook.com/docs/marketing-api/reference/ad-account/insights/}{documentation} for more information
#' 
