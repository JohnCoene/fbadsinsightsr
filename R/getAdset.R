...
#' 
#' @param adset.id The id of the adset you want to retrieve (Required), see \href{https://www.facebook.com/business/help/1492627900875762}{how to find yours}.
...
getAdset <- function(adset.id, fields = "default",
  ...
  url <- paste0(base_url, adset.id, "/insights?fields=",fields,
